...
export const metadata: Metadata = {
  title: "Elektrik & Elektronik Taahhüt İşleri - Villa Projeleri ve Akıllı Ev Sistemleri - Tezel Mühendislik",
  description:
  ...
  keywords:
    "villa elektrik, akıllı ev sistemleri, KNX, otomasyon, güvenlik sistemleri, elektrik taahhüt, Tezel Mühendislik",
  openGraph: {
    title: "Elektrik & Elektronik Taahhüt İşleri - Tezel Mühendislik",
    description: "Villa projeleri için akıllı ev sistemleri ve otomasyon çözümleri.",
    type: "website",
    locale: "tr_TR",
  },
};
...
/**
 * Elektrik & Elektronik Taahhüt İşleri sayfası
 */
export default function ElectricalElectronicsPage() {
  const serviceDetail = getServiceDetailBySlug("elektrik-elektronik-taahhut");
